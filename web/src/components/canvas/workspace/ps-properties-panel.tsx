    ...
    return (
        <section className="flex min-h-0 flex-1 flex-col">
            <div className="flex shrink-0 items-center gap-1 px-2 py-1.5">
                ...
                <span className="min-w-0 flex-1 truncate text-sm font-medium" style={{ color: theme.node.label }}>{t("canvas.ps.properties")}</span>
            </div>
            {!selected || !box ? (
                <p className="px-3 pb-3 text-sm glass-card" style={{ color: theme.node.muted }}>
