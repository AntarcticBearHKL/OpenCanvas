                ...
                <div className="grid gap-6 md:grid-cols-[minmax(260px,1fr)_320px]">
                    <div className="min-w-0 rounded-xl border p-4" style={{ borderColor: theme.node.stroke }}>
                        <div className="relative inline-block">
                            <img src={dataUrl} alt="" className="block max-h-[340px] w-auto max-w-full cursor-crosshair rounded-md" draggable={false} onPointerDown={addPoint} onContextMenu={(event) => event.preventDefault()} />
                            {meta
