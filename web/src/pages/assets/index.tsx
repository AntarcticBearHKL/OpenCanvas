    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-1 px-4 pb-4">
                <Button size="small" icon={<Eye className="size-3.5" />} title={t("common.view")} aria-label={t("common.view")} onClick={onOpen} />
                {asset.kind !== "video" ? <Button size="small" icon={<PencilLine className="size-3.5" />} title={t("common.edit")} aria-label={t("common.edit")} onClick={onEdit} /> : null}
                {asset.kind === "text" ? <Button size="small" icon={<Copy className="size-3.5" />} title={t("common.copy")} aria-label={t("common.copy")} onClick={() => void onCopy(asset)} /> : null}
                {asset.kind === "image" || asset.kind === "video" ? <Button size="small" icon={<Download className="size-3.5" />} title={t("common.download")} aria-label={t("common.download")} onClick={() => onDownload(asset)} /> : null}
                <Button size="small" danger icon={<Trash2 className="size-3.5" />} title={t("common.delete")} aria-label={t("common.delete")} onClick={onDelete} />
            </div>
        </Card>
    );
}
