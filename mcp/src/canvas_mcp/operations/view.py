...
def connect_nodes(input_data: dict[str, Any], _state: CanvasSnapshot | None) -> dict[str, Any]:
    return apply_ops([{"type": "connect_nodes", **connection} for connection in input_data["connections"]])


def select_nodes(input_data: dict[str, Any], _state: CanvasSnapshot | None) -> dict[str, Any]:
    return apply_ops([{"type": "select_nodes", "ids": input_data["ids"]}])


def set_viewport(input_data: dict[str, Any], _state: CanvasSnapshot | None) -> dict[str, Any]:
