...
Drag image files onto the canvas to upload them. Undo and redo cover nodes, edges, the viewport, and background mode; they do not cover the project name, account state, or global AI settings.
